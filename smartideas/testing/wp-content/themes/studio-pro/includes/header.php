 ...
 * Studio Pro Theme
 *
 * This file adds the page header to the Studio Pro Theme.
 *
 * @package   StudioPro
...
add_action( 'genesis_before', 'studio_page_header_setup' );
/**
 * Set up page header.
 *
 ...
 * @return void
 */
function studio_page_header_setup() {
	...
	add_action( 'studio_page_header', 'genesis_do_posts_page_heading' );
	add_action( 'studio_page_header', 'genesis_do_date_archive_title' );
	add_action( 'studio_page_header', 'genesis_do_taxonomy_title_description' );
	add_action( 'studio_page_header', 'genesis_do_author_title_description' );
	add_action( 'studio_page_header', 'genesis_do_cpt_archive_title_description' );
...
add_action( 'genesis_before_content_sidebar_wrap', 'studio_remove_404_title' );
/**
 ...
 * @return void
 */
function studio_remove_404_title() {
...
add_action( 'studio_page_header', 'studio_page_title', 10 );
/**
...
add_action( 'studio_page_header', 'studio_page_excerpt', 20 );
/**
...
add_action( 'genesis_before_content_sidebar_wrap', 'studio_page_header' );
/**
 * Display the page header.
 *
 * Conditionally outputs the opening and closing page header markup and runs
 * studio_page_header which all of our header functions are hooked to.
 *
 * @since  2.2.4
 *
 * @return void
 */
function studio_page_header() {

	// Output opening markup.
	if ( apply_filters( 'studio_page_header_open', true ) ) {
	 ...
	 */
	do_action( 'studio_page_header' );

	// Output closing markup.
	if ( apply_filters( 'studio_page_header_close', true ) ) {
