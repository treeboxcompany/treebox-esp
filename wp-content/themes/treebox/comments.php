...
<?php  
    ...
    <h2 class="comments-header"><?php _e($numComments); ?> Comentarios</h2> 
    <ol id="comments"> 
...
?> 
    ...
    <h2 class="comments-header">No hay comentarios a&uacute;n</h2> 

    <p>Usted puede ser el primero en comentar.</p> 
 ...
 */ ?> 
    ...
    <h2 id="comments-header">Queremos saber su opini&oacute;n</h2> 
    ...
    <?php else : ?> 
        ...
        <p>
        <label for="author">Nombre<?php if ($req) _e(' (requerido)'); ?></label>
        <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" /> 
        </p> 
         
        <p>
        <label for="email">Correo Electr&oacute;nico (no ser&aacute; publicado)<?php if ($req) _e(' (required)'); ?></label>
    ...
    <?php /* You might want to display this:  
        ...
        <?php /* Buttons are easier to style than input[type=submit],  
                ...
                if you like */  
        ?> 
        <p><button type="submit" name="submit" id="sub">Comentar</button> 
